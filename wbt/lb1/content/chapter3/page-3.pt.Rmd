...
![Visão geral de um grupo](../img/groupteaching.png)
...
## Três passos do Git: Commit, Pull & Push {/examples}
...
![Visualização do Git no RStudio](../img/rstudio-git1.png)
...
![Arquivo modificado](../img/rstudio-git2.png)
...
![Janela de Commit](../img/rstudio-git3.png)
